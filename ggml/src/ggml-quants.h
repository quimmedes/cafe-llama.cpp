...
GGML_API void quantize_row_f8_ref(const float * GGML_RESTRICT x, block_f8 * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_f8(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * quant_weights);
