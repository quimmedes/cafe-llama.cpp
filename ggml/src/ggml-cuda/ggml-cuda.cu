        ...
        case GGML_OP_SET_ROWS:
            {
                return (
                           (
                               ...
                               op->type == GGML_TYPE_Q5_1 || op->type == GGML_TYPE_Q8_0 || op->type == GGML_TYPE_IQ4_NL || op->type == GGML_TYPE_TURBO4_0 || op->type == GGML_TYPE_TURBO2_0 || op->type == GGML_TYPE_TURBO3_0) &&
