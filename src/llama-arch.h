...
enum llm_kv {
    ...
    LLM_KV_FEED_FORWARD_PARALLEL_LENGTH,
...
enum llm_tensor {
    ...
    LLM_TENSOR_FFN_DOWN,
    LLM_TENSOR_FFN_UP,
    LLM_TENSOR_FFN_GATE_PAR,
    LLM_TENSOR_FFN_DOWN_PAR,
    LLM_TENSOR_FFN_UP_PAR,
    LLM_TENSOR_FFN_ACT,
    ...
    // qwen4exp: the MTP head ends in its own hyper-connection mixer rather than a plain
    // output norm, mirroring the trunk's hc_head_* (which is its output norm)
