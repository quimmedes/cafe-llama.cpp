...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_DSPARK_HIDDEN_CORRECTION,          "%s.dspark.hidden_correction"          },
    { LLM_KV_DSPARK_MARKOV_DEPLOY_EXPOSURE,     "%s.dspark.markov_deploy_exposure"     },
    { LLM_KV_DSPARK_CORRECTION_SIZE,            "%s.dspark.correction_size"            },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_DSPARK_PROD_LOG_SNR_FC1,  "dspark.log_snr_fc1"             },
    { LLM_TENSOR_DSPARK_MODE_EMBEDDING,    "dspark.mode_embedding"          },
    { LLM_TENSOR_DSPARK_PROD_LOG_SNR_FC2,  "dspark.log_snr_fc2"             },
    { LLM_TENSOR_DSPARK_CORR_HNORM,        "dspark.correction_hidden_norm"  },
    { LLM_TENSOR_DSPARK_CORR_ENORM,        "dspark.correction_embed_norm"   },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    { LLM_TENSOR_DSPARK_PROD_LOG_SNR_FC1,  { LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT }       },
    { LLM_TENSOR_DSPARK_MODE_EMBEDDING,    { LLM_TENSOR_LAYER_INPUT, GGML_OP_ADD }            },
    { LLM_TENSOR_DSPARK_PROD_LOG_SNR_FC2,  { LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT }       },
    { LLM_TENSOR_DSPARK_CORR_HNORM,        { LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL }           },
    { LLM_TENSOR_DSPARK_CORR_ENORM,        { LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL }           },
    { LLM_TENSOR_DSPARK_CORR_GATE,         { LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT }       },
    { LLM_TENSOR_DSPARK_CORR_UP,           { LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT }       },
    { LLM_TENSOR_DSPARK_CORR_DOWN,         { LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT }       },
    // Nemotron 3 Super
