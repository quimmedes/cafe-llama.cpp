        ...
        if (qs.params->token_embedding_type < GGML_TYPE_COUNT) {
            ...
            if (ftype == LLAMA_FTYPE_MOSTLY_IQ2_XXS || ftype == LLAMA_FTYPE_MOSTLY_IQ2_XS ||
                ...
                new_type = GGML_TYPE_IQ3_S;
                     ...
                     ftype == LLAMA_FTYPE_MOSTLY_Q1_0  || ftype == LLAMA_FTYPE_MOSTLY_Q2_0 ||
                     ftype == LLAMA_FTYPE_MOSTLY_PQ2_0 || ftype == LLAMA_FTYPE_MOSTLY_PTQ1_0) {
...
static void llama_model_quantize_impl(const std::string & fname_inp, const std::string & fname_out, const llama_model_quantize_params * params) {
    ...
    llama_model_loader ml(/*metadata*/ nullptr, /*source*/ nullptr, /*set_tensor_data*/ nullptr, /*set_tensor_data_ud*/ nullptr,
